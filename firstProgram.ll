...
define internal fastcc double @lambda(<2 x double> %z, double %y) #0 {
entry:
  %0 = fadd double %y, 6.000000e+00
  ret double %0
}

; Function Attrs: nounwind readnone
define internal fastcc double @fib(double %x, <2 x double> %z, double %y) #0 {
entry:
...
entry:
  %0 = tail call fastcc double @fib(double 1.000000e+00, <2 x double> <double 1.000000e+00, double 2.000000e+00>, double 6.000000e+00)
  %1 = tail call fastcc double @lambda(<2 x double> <double 1.000000e+00, double 2.000000e+00>, double 6.000000e+00)
  %2 = fadd double %0, %1
